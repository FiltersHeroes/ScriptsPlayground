...
if [[ $1 == "KAD" ]]; then
    ...
    mkdir -p "$MAIN_PATH"/split/
    split -d -n l/10 "$MAIN_PATH"/VICHS_Test/LWS.txt "$MAIN_PATH"/split/LWS_
...
$1 == "LWS_00" || $1 == "LWS_01" || $1 == "LWS_02" || $1 == "LWS_03" || $1 == "LWS_04" || $1 == "LWS_05" || $1 == "LWS_06" || $1 == "LWS_07" || $1 == "LWS_08" || $1 == "LWS_09" || $1 == "LWS_10" ]]; then
